...
def main():
    is_test = False
    imu_loc = "../Data/Train/IMU/imuRaw1.mat"
    vicon_loc = "../Data/Train/Vicon/viconRot1.mat"
    imu_params_loc = (
        "../IMUParams.mat"
    )
    try:
        imu = IMU(imu_loc, vicon_loc, imu_params_loc, is_test)
    except:
        imu = IMU_alt(imu_loc, vicon_loc, imu_params_loc, is_test)
